...
//   exclude: ["/admin", "/dashboard","/reset-password" , "/forgot-password"], // Exclude these routes from sitemap
//   changefreq: "weekly", // Default change frequency for URLs
//   priority: 0.8, // Default priority for URLs
//   robotsTxtOptions: {
//     policies: [
//       { userAgent: "*", allow: "/" },
//       { userAgent: "*", disallow: ["/admin", "/dashboard" ,"/reset-password" , "/forgot-password"] }, // Excluded paths
//     ],
//   },
